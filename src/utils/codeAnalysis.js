...
export const getCodeSummary = (content, language) => {
...
export const findVulnerabilities = (content, language) => {
...
export const extractFunctionNames = (content, language) => {
  if (!content) return [];
...
export const extractImports = (content, language) => {
  if (!content) return [];
...
export const findPotentialErrorLocations = (content, errorMessage) => {
